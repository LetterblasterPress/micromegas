...
This outlines how to propose a change to micromegas. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("LetterblasterPress/micromegas", fork = TRUE)`.
...
Please note that the micromegas project is released with a [Contributor
Code of
Conduct](https://letterblasterpress.github.io/micromegas/CODE_OF_CONDUCT.md).
